...
class AirtableClient(metaclass=Singleton):
    ...
    def get_hub_by_id(
        ...
        raw = self.client_api.get(
            base_id=BASE_ID,
            table_name=HUBS_TABLE_NAME,
            record_id=hub_id)
        return AirtableHubResponse.parse_obj(raw)

    @cached(cache=TTLCache(maxsize=1024, ttl=600))
    def get_hub_by_school_id(
            self,
            school_id
    ) -> Optional[AirtableHubResponse]:
    ...
    @cached(cache=TTLCache(maxsize=1024, ttl=600))
    def get_hubs_by_entrepreneur_id(
            self,
            partner_id
    ) -> ListAirtableHubResponse:
    ...
    def get_pod_by_id(
        ...
        raw = self.client_api.get(
            base_id=BASE_ID,
            table_name=PODS_TABLE_NAME,
            record_id=pod_id)
        return AirtablePodResponse.parse_obj(raw)

    @cached(cache=TTLCache(maxsize=1024, ttl=600))
    def get_pod_by_school_id(
            self,
            school_id
    ) -> Optional[AirtablePodResponse]:
        formula = formulas.INCLUDE(formulas.STR_VALUE(school_id), formulas.FIELD("School Record IDs"))
    ...
    @cached(cache=TTLCache(maxsize=32, ttl=600))
    def get_pods_by_hub_id(
            self,
            hub_id
    ) -> ListAirtablePodResponse:
    ...
    def list_schools(
            ...
            page_size=100,
            offset=None
    ) -> (ListAirtableSchoolResponse, str):
    ...
    @cached(cache=TTLCache(maxsize=1024, ttl=600))
    def get_schools_by_educator_id(
            self,
            educator_id
    ) -> ListAirtableSchoolResponse:
    ...
    @cached(cache=TTLCache(maxsize=1024, ttl=600))
    def get_guide_school_by_id(
            self,
            guide_school_id
    ) -> AirtableGuidesSchoolsResponse:
        raw = self.client_api.get(
            base_id=BASE_ID,
            table_name=GUIDES_SCHOOLS_TABLE_NAME,
            record_id=guide_school_id)
        return AirtableGuidesSchoolsResponse.parse_obj(raw)

    def list_guide_schools_by_ids(
            self,
            guide_school_ids=None
    ) -> ListAirtableGuidesSchoolsResponse:
    ...
    ) -> (ListAirtablePartnerResponse, str):
        raw, res_offset = self.client_api.paginate(
    ...
    def get_partner_by_id(self, school_id, load_relationships=True) -> AirtablePartnerResponse:
        raw = self.client_api.get(
            base_id=BASE_ID,
            table_name=PARTNERS_TABLE_NAME,
            record_id=school_id)
    ...
    @cached(cache=TTLCache(maxsize=32, ttl=600))
    def get_partner_by_synced_record_id(
            self,
            synced_record_id,
            load_relationships=True
    ) -> AirtablePartnerResponse:
    ...
    @cached(cache=TTLCache(maxsize=32, ttl=600))
    def get_partners_by_hub_id(
            self,
            hub_id,
            load_relationships=True
    ) -> ListAirtablePartnerResponse:
        formula = formulas.INCLUDE(formulas.STR_VALUE(hub_id), formulas.FIELD("Hub Record ID"))
    ...
    def create_educator(
            self,
            payload: CreateAirtableEducatorFields,
            load_relationships=True
    ) -> AirtableEducatorResponse:
    ...
    def add_typeform_start_a_school_response_to_educator(
            self,
            educator_id,
            typeform_start_a_school_response_id,
            load_relationships=True
    ) -> AirtableEducatorResponse:
        ...
        raw = self.client_api.update(
            ...
            table_name=EDUCATORS_TABLE_NAME,
            record_id=educator_id,
            fields={AirtableEducatorFields.__fields__[
    ...
    def get_current_tls_by_school_id(
            self, school_id, load_relationships=True
    ) -> ListAirtableEducatorResponse:
    ...
    def create_educator_schools(
            self,
            payload: CreateUpdateAirtableEducatorsSchoolsFields
    ) -> AirtableEducatorsSchoolsResponse:
        raw = self.client_api.create(
            base_id=BASE_ID,
            table_name=EDUCATORS_SCHOOLS_TABLE_NAME,
    ...
    def get_montessori_education_by_id(
        ...
        raw = self.client_api.get(
            base_id=BASE_ID,
            table_name=MONTESSORI_CERTIFICATIONS_TABLE_NAME,
    ...
    def create_montessori_certification(
            self,
            payload: CreateAirtableMontessoriCertificationFields
    ) -> AirtableMontessoriCertificationResponse:
        raw = self.client_api.create(
            base_id=BASE_ID,
            table_name=MONTESSORI_CERTIFICATIONS_TABLE_NAME,
    ...
    def get_language_by_id(self, language_id) -> AirtableLanguageResponse:
        raw = self.client_api.get(
            base_id=BASE_ID,
            table_name=LANGUAGES_TABLE_NAME,
            record_id=language_id)
        return AirtableLanguageResponse.parse_obj(raw)

    def create_language(
            self, payload: CreateAirtableLanguageFields) -> AirtableLanguageResponse:
        raw = self.client_api.create(
            base_id=BASE_ID,
            table_name=LANGUAGES_TABLE_NAME,
            fields=payload.dict(by_alias=True)
    ...
    def create_start_a_school_response(
            self,
            payload: CreateAirtableSSJTypeformStartASchool
    ) -> AirtableSSJTypeformStartASchoolResponse:
        raw = self.client_api.create(
            base_id=BASE_ID,
            table_name=SSJ_TYPEFORM_RESPONSES_TABLE_NAME,
            fields=payload.dict(by_alias=True)
        )
    ...
    def create_contact_info(
            self,
            payload: CreateAirtableContactInfoFields
    ) -> AirtableContactInfoResponse:
        raw = self.client_api.create(
            base_id=BASE_ID,
            table_name=CONTACT_INFO_TABLE_NAME,
            fields=payload.dict(by_alias=True)
        )
    ...
    def create_socio_economic(
            self,
            payload: CreateAirtableSocioEconomicBackgroundFields
    ) -> AirtableSocioEconomicBackgroundResponse:
        raw = self.client_api.create(
            base_id=BASE_ID,
            table_name=SOCIO_ECONOMIC_BACKGROUNDS_TABLE_NAME,
            fields=payload.dict(by_alias=True)
        )
        return AirtableSocioEconomicBackgroundResponse.parse_obj(raw)

    def list_newsletters_by_ids(
            self,
            newsletter_ids
    ) -> ListAirtableNewsletterResponse:
        match_formulas = []
    ...
    def get_newsletters_by_slug(
            self,
            slugs: list[NewsletterSlugs]
    ) -> ListAirtableNewsletterResponse:
        match_formulas = []
        for s in slugs:
    ...
    def list_field_categories(self) -> ListAirtableFieldCategoriesResponse:
        raw = self.client_api.all(
            base_id=BASE_ID,
            table_name=FIELD_CATEGORIES_TABLE_NAME)
    ...
    def list_field_mappings(self) -> ListAirtableFieldMappingResponse:
        raw = self.client_api.all(
            base_id=BASE_ID,
            table_name=FIELD_MAPPING_TABLE_NAME)
