...
class CreateAirtableSSJTypeformStartASchool(BaseModel):
    ...
    school_location_country: str = Field(alias="School Location: Country")
    school_location_community: str = Field(alias="School Location: Community")
    contact_location_city: str = Field(alias="Contact Location: City")
    contact_location_state: str = Field(alias="Contact Location: State")
    contact_location_country: str = Field(alias="Contact Location: Country")
