...
SSJ_TYPEFORM_START_A_SCHOOL_RESPONSES_TABLE_NAME = "SSJ Typeforms: Start a School"
SSJ_FILLOUT_GET_INVOLVED_RESPONSES_TABLE_NAME = "SSJ Fillout Form: Get Involved"
