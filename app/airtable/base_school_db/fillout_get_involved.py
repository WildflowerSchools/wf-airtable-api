...
class CreateAirtableSSJFilloutGetInvolved(BaseModel):
    ...
    montessori_certification_level_1: Optional[list[str]] = Field(alias="Montessori Certification Level 1")
    ...
    montessori_certification_level_2: Optional[list[str]] = Field(alias="Montessori Certification Level 2")
    ...
    montessori_certification_level_3: Optional[list[str]] = Field(alias="Montessori Certification Level 3")
    ...
    montessori_certification_level_4: Optional[list[str]] = Field(alias="Montessori Certification Level 4")
    city: str = Field(alias="City")
    state: str = Field(alias="State")
    country: Optional[str] = Field(alias="Country")
    age_classrooms_interested_in_offering: Optional[list[str]] = Field(alias="Age Classrooms Interested In Offering")
    educator_interests: Optional[list[str]] = Field(alias="Educator Interests")
    ...
    community_member_support_finding_teachers: Optional[bool] = Field(alias="Community Member Support Finding Teachers", default=False)
    ...
    socio_economic_race_and_ethnicity: Optional[list[str]] = Field(alias="Socio-Economic: Race & Ethnicity")
